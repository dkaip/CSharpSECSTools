...
namespace com.CIMthetics.CSharpSECSTools.SECSItems 
{
	...
	public class F8ArraySECSItem : SECSItem
	{
		...
		/// <summary>
		/// The value of this <c>F8ArraySECSItem</c>.
		/// </summary>
		public double[] Value { get { return _value; } }

        /// <summary>
        /// This constructor creates a <c>F8ArraySECSItem</c> with no elements.
        /// </summary>
		public F8ArraySECSItem() : base(SECSItemFormatCode.F8, 0)
		{
            this._value = new double[0];
		}

        /// <summary>
        /// This constructor creates an F8ArraySECSItem that will have the value of
        /// the supplied <c>double[]</c>.
        /// </summary>
        /// <param name="value">An array of <c>double</c> values to be assigned to this <c>SECSItem</c>.</param>
        /// <remarks>
        /// The array's length should not exceed <c>2097151</c> elements.
        /// </remarks>
		public F8ArraySECSItem(double[]? value) : base(SECSItemFormatCode.F8, value == null ? 0 : value.Length * 8)
		{
			if (value == null)
				this._value = new double[0];
			else
        ...
        /// the length of the content of the <c>double[]</c>.
        /// </summary>
        ...
        /// The array's length should not exceed <c>2097151</c> elements.
        /// </remarks>
		public F8ArraySECSItem(double[]? value, SECSItemNumLengthBytes desiredNumberOfLengthBytes) : base(SECSItemFormatCode.F8, value == null ? 0 : value.Length * 8, desiredNumberOfLengthBytes)
		{
			if (value == null)
				this._value = new double[0];
			else
		...
		internal F8ArraySECSItem(byte[] data, int itemOffset) : base(data, itemOffset)
		{
			...
			_value = new double[LengthInBytes / 8];
			...
			for (int i = offset, j = 0; j < _value.Length; i += 8, j++)
			{
				...
				_value[j] = BitConverter.ToDouble(temp, 0);
			}
		}
