...
{
    /// <summary>
    /// This class represents/implements a <code>SECSItem</code> with the SECS data type of <c>F8</c>,
    /// which is an 8 byte floating point number. From the C# side this data type is handled as a 
    /// C# <c>double</c>.
    /// </summary>
	public class F8SECSItem : SECSItem
	{
        ...
        /// <summary>
        /// This constructor creates a <c>SECSItem</c> that has a type of <c>F8</c>
	    ...
	    public F8SECSItem(byte[] data, int itemOffset) : base(data, itemOffset)
	    {
        ...
        /// <see cref="T:com.CIMthetics.CSharpSECSTools.SECSItems.F8SECSItem"/>; otherwise, <c>false</c>.</returns>
