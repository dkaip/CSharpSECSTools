...
{
    /// <summary>
    /// This class represents a <c>SECSItem</c> with the SECS data type of <c>F4</c>,
    ///  which is a 32-bit floating point number. From the C# side this data type is handled as a C# <c>float</c>.
    /// </summary>
	public class F4SECSItem : SECSItem
	{
		...
		/// <summary>
		/// The value of this <c>F4SECSItem</c>.
		/// </summary>
		public float Value { get { return _value; } }

        /// <summary>
        /// This constructor creates an F4SECSItem that will have the value of
	    ...
	    internal F4SECSItem(byte[] data, int itemOffset) : base(data, itemOffset)
	    {
			...
			_value = BitConverter.ToSingle(temp, 0);
	    }
        ...
        /// <see cref="T:com.CIMthetics.CSharpSECSTools.SECSItems.F4SECSItem"/>, <c>false</c> otherwise.</returns>
