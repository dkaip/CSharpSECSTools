...
{
    /// <summary>
    /// This class represents/implements a <c>SECSItem</c> with the SECS data type of <c>I4</c>,
    ///  which is an Int32. From the C# side this data type is handled as a C# <c>Int32</c>.
    /// </summary>
	public class I4SECSItem : SECSItem
	{
		...
		/// <summary>
		/// The value of this <c>I4SECSItem</c>.
		/// </summary>
		public Int32 Value { get { return _value; } }

        /// <summary>
        /// This constructor creates an I4SECSItem that will have the value of
	    ...
	    internal I4SECSItem(byte[] data, int itemOffset) : base(data, itemOffset)
	    {
			...
			_value = BitConverter.ToInt32(temp, 0);
	    }
        ...
        /// <summary>
        /// Serves as a hash function for a <see cref="T:com.CIMthetics.CSharpSECSTools.SECSItems.I4SECSItem"/> object.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the specified <see cref="object"/> is equal to the current <see cref="T:com.CIMthetics.CSharpSECSTools.SECSItems.I4SECSItem"/>.
        /// </summary>
        /// <param name="obj">The <see cref="object"/> to compare with the current <see cref="T:com.CIMthetics.CSharpSECSTools.SECSItems.I4SECSItem"/>.</param>
        /// <returns><c>true</c> if the specified <see cref="object"/> is equal to the current
        /// <see cref="T:com.CIMthetics.CSharpSECSTools.SECSItems.I4SECSItem"/>, <c>false</c> otherwise.</returns>
