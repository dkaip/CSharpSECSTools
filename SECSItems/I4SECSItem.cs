...
{
    /// <summary>
    /// This class represents/implements a <c>SECSItem</c> with the 
    /// SECS data type of <c>I4</c>, which is a 4 byte (32-bit) signed 
    /// integer number. From the C# side this data type is handled as a 
    /// C# <code>Int32</code>.
    /// </summary>
	public class I4SECSItem : SECSItem
	{
        ...
        /// <summary>
        /// This constructor creates a <c>SECSItem</c> that has a type of <c>I4</c> 
        ...
        /// <see cref="T:com.CIMthetics.CSharpSECSTools.SECSItems.I4SECSItem"/>; otherwise, <c>false</c>.</returns>
