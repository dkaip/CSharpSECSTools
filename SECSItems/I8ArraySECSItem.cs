...
{
    /// <summary>
    /// This class represents/implements a SECSItem with the SECS data type of <c>I8</c>
    /// in an array form. In this case it is an array of zero or more 64-bit signed integers.
    /// From the C# side this data type is handled as a C# <c>Int64 []</c>.
    /// 
	...
	public class I8ArraySECSItem : SECSItem
	{
        ...
        /// <summary>
        /// This constructor creates a SECSItem that has a type of <c>I8</c> with 
        /// the minimum number of length bytes required.
        /// Note: It will be created with the number of length bytes required
        /// based on the length (in elements) of the <c>Int64 []</c> provided.
        ...
        /// <summary>
        /// This constructor creates a SECSItem that has a type of <c>I8</c>
        ...
        /// length (in elements) of the <c>Int64 []</c> provided.
        /// </summary>
		...
		public I8ArraySECSItem(Int64[] value, SECSItemNumLengthBytes desiredNumberOfLengthBytes) : base(SECSItemFormatCode.I8, value.Length * 8, desiredNumberOfLengthBytes)
		{
			this.value = value;
		}
