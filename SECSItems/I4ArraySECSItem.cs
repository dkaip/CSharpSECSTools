...
{
    /// <summary>
    /// This class represents a SECS item with a data type of <c>I4</c>
    /// in an array form. In this case it is an array of zero or more 32-bit signed integers.
    /// The C# data type is <c>Int32[]</c>.
    /// </summary>
	public class I4ArraySECSItem : SECSItem
	{
		...
		/// <summary>
		/// The value of this <c>I4ArraySECSItem</c>.
		/// </summary>
		public Int32[] Value { get { return _value; } }

        /// <summary>
        /// This constructor creates a <c>I4ArraySECSItem</c> with no elements.
        /// </summary>
		public I4ArraySECSItem() : base(SECSItemFormatCode.I4, 0)
		{
            this._value = new Int32[0];
		}

        /// <summary>
        /// This constructor creates an I4ArraySECSItem that will have the value of
        /// the supplied <c>Int32[]</c>.
        /// </summary>
        /// <param name="value">An array of <c>Int32</c> values to be assigned to this <c>SECSItem</c>.</param>
        /// <remarks>
        /// The array's length should not exceed <c>4194303</c> elements.
        /// </remarks>
		public I4ArraySECSItem(Int32[]? value) : base(SECSItemFormatCode.I4, value == null ? 0 : value.Length * 4)
		{
			if (value == null)
				this._value = new Int32[0];
			else
        ...
        /// <summary>
        /// This constructor creates a I4ArraySECSItem that will have the value of
        /// the supplied <c>Int32[]</c>.  In addition when converted to 
        ...
        /// the length of the content of the <c>Int32[]</c>.
        /// </summary>
        ...
        /// The array's length should not exceed <c>4194303</c> elements.
        /// </remarks>
		public I4ArraySECSItem(Int32[]? value, SECSItemNumLengthBytes desiredNumberOfLengthBytes) : base(SECSItemFormatCode.I4, value == null ? 0 : value.Length * 4, desiredNumberOfLengthBytes)
		{
			if (value == null)
				this._value = new Int32[0];
			else
		...
		public I4ArraySECSItem(byte[] data, int itemOffset) : base(data, itemOffset)
		{
			...
			_value = new Int32[LengthInBytes / 4];
			...
			for (int i = offset, j = 0; j < _value.Length; i += 4, j++)
			{
				...
				_value[j] = BitConverter.ToInt32(temp, 0);
			}
		}
        ...
        /// <see cref="T:com.CIMthetics.CSharpSECSTools.SECSItems.I4ArraySECSItem"/>, <c>false</c> otherwise.</returns>
