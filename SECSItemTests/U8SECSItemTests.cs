...
namespace com.CIMthetics.CSharpSECSTools.SECSItemTests
{
	...
	public class U8SECSItemTests
	{
        ...
        public void Test00()
        {
            ...
            Assert.IsTrue(secsItem.GetType() == typeof(U8SECSItem));
        }
        ...
        public void Test01()
        {
            ...
            U8SECSItem secsItem = (U8SECSItem)SECSItemFactory.GenerateSECSItem(input);
    ...
    public void Test11()
        ...
        public void Test21()
        {
            ...
            Assert.IsTrue(secsItem1.GetHashCode() == -1952889864);
        }
