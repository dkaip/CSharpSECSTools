    ...
    public void Test01()
        {
            ...
            Assert.IsTrue(secsItem.Value[1] == -2147483648);
            Assert.IsTrue(secsItem.Value[2] == 0);
            Assert.IsTrue(secsItem.Value[3] == 1);
            Assert.IsTrue(secsItem.Value[4] == 2147483647);
        }
        ...
        public void Test03()
        {
            byte [] input = { (byte)((SECSItemFormatCodeFunctions.GetNumberFromSECSItemFormatCode(SECSItemFormatCode.I4) << 2) | 0x01), 20,
                ...
                127, 255, 255, 255 };
            I4ArraySECSItem secsItem = new I4ArraySECSItem(input, 0);
            Assert.IsTrue(secsItem.ItemFormatCode == SECSItemFormatCode.I4);
        }
        ...
        public void Test15()
        {
            ...
            I4ArraySECSItem secsItem = (I4ArraySECSItem)SECSItemFactory.GenerateSECSItem(input);
